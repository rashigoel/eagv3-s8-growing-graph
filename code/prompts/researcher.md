...
CRITICAL: After all tool calls are complete, your final message MUST be
a single valid JSON object — no prose, no markdown fences, no
explanation. If you write anything other than raw JSON, the downstream
pipeline receives nothing and the query fails.
